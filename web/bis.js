...
//   - Tome of Fiery Redemption (30447): a +290 spell-damage proc. GetItemStats reports NOTHING for
//     it, so it never appears in the auto lists — it's added to the early-phase trinket lists by
//     hand. Its proc IS now scored (src/procs.js models it at its measured uptime, ~66 SP), which
//     puts it ahead of Eye of Magtheridon for single-target threat, as it plays.
...
export const BIS = {
  1: {
    ...
    trinket: [{ id: 27529, name: 'Figurine of the Colossus' }, { id: 28528, name: 'Moroes\' Lucky Pocket Watch' }, { id: 23836, name: 'Goblin Rocket Launcher' }, { id: 29387, name: 'Gnomeregan Auto-Blocker 600', note: 'Badge of Justice vendor. Block-value threat trinket (+59 block value; the on-use +200 for 20s isn\'t modeled).' }, { id: 30447, name: 'Tome of Fiery Redemption', note: 'Its +290 spell-damage proc is scored at the measured raid uptime (~66 SP average), so it\'s left out of the auto-generated list but valued properly here — stronger single-target threat than Eye of Magtheridon.' }, { id: 29370, name: 'Icon of the Silver Crescent' }, { id: 28789, name: 'Eye of Magtheridon' }],
  ...
  2: {
    head: [{ id: 30125, name: 'Crystalforge Faceguard' }, { id: 29068, name: 'Justicar Faceguard' }, { id: 32473, name: 'Tankatronic Goggles', note: 'Engineering only (requires Engineering to wear). An epic ilvl-127 tank head — a strong Phase-2 option for an Engineer, outclassed by tier heads from Phase 3 on.' }],
    ...
    trinket: [{ id: 27529, name: 'Figurine of the Colossus' }, { id: 28528, name: 'Moroes\' Lucky Pocket Watch' }, { id: 27891, name: 'Adamantine Figurine' }, { id: 23836, name: 'Goblin Rocket Launcher', note: 'Engineering only (Goblin Engineer). +45 stamina and an on-use rocket for burst threat/pulls — available from Phase 1 on.' }, { id: 29387, name: 'Gnomeregan Auto-Blocker 600', note: 'Badge of Justice vendor. Block-value threat trinket (+59 block value; the on-use +200 for 20s isn\'t modeled).' }, { id: 30447, name: 'Tome of Fiery Redemption', note: 'Its +290 spell-damage proc is scored at the measured raid uptime (~66 SP average), so it\'s left out of the auto-generated list but valued properly here — stronger single-target threat than Eye of Magtheridon.' }, { id: 29370, name: 'Icon of the Silver Crescent' }, { id: 28789, name: 'Eye of Magtheridon' }],
  ...
  3: {
    ...
    trinket: [{ id: 31858, name: 'Darkmoon Card: Vengeance' }, { id: 31859, name: 'Darkmoon Card: Madness' }, { id: 23836, name: 'Goblin Rocket Launcher' }, { id: 29387, name: 'Gnomeregan Auto-Blocker 600', note: 'Badge of Justice vendor. Block-value threat trinket (+59 block value; the on-use +200 for 20s isn\'t modeled).' }, { id: 30447, name: 'Tome of Fiery Redemption', note: 'Its +290 spell-damage proc is scored at the measured raid uptime (~66 SP average), so it\'s left out of the auto-generated list but valued properly here — a strong single-target threat trinket that stays usable while tank trinket upgrades are scarce.' }, { id: 29370, name: 'Icon of the Silver Crescent' }, { id: 28789, name: 'Eye of Magtheridon' }],
  ...
  4: {
    ...
    chest: [{ id: 30991, name: 'Lightbringer Chestguard' }, { id: 30896, name: 'Glory of the Defender' }, { id: 33473, name: 'Chestguard of the Warlord' }, { id: 33522, name: 'Chestguard of the Stoic Guardian', note: 'Badge of Justice (P4) vendor — avoidance + spell-power tank chest, three sockets.' }],
    wrist: [{ id: 32279, name: 'The Seeker\'s Wristguards' }, { id: 32232, name: 'Eternium Shell Bracers' }, { id: 33889, name: 'Vindicator\'s Lamellar Bracers' }, { id: 33516, name: 'Bracers of the Ancient Phalanx', note: 'Badge of Justice (P4) vendor — expertise-leaning threat/tank bracer.' }],
    hands: [{ id: 30985, name: 'Lightbringer Handguards' }, { id: 29998, name: 'Royal Gauntlets of Silvermoon' }, { id: 33517, name: 'Bonefist Gauntlets' }],
    waist: [{ id: 32342, name: 'Girdle of Mighty Resolve' }, { id: 33524, name: 'Girdle of the Protector' }, { id: 32333, name: 'Girdle of Stability' }, { id: 33279, name: 'Iron-tusk Girdle', note: 'Badge of Justice (P4) vendor — avoidance tank belt (defense + dodge).' }],
    ...
    ring: [{ id: 30083, name: 'Ring of Sundered Souls' }, { id: 32261, name: 'Band of the Abyssal Lord' }, { id: 29172, name: 'Ashyen\'s Gift' }],
    trinket: [{ id: 31858, name: 'Darkmoon Card: Vengeance' }, { id: 31859, name: 'Darkmoon Card: Madness' }, { id: 23836, name: 'Goblin Rocket Launcher' }, { id: 30447, name: 'Tome of Fiery Redemption', note: 'Its +290 spell-damage proc is scored at the measured raid uptime (~66 SP average), so it\'s left out of the auto-generated list but valued properly here — a strong single-target threat trinket that stays usable while tank trinket upgrades are scarce.' }, { id: 29370, name: 'Icon of the Silver Crescent' }, { id: 28789, name: 'Eye of Magtheridon' }],
    weapon: [{ id: 30910, name: 'Tempest of Chaos' }, { id: 33687, name: 'Vengeful Gladiator\'s Gavel' }, { id: 34009, name: 'Hammer of Judgement' }],
    offhand: [{ id: 32375, name: 'Bulwark of Azzinoth' }, { id: 30909, name: 'Antonidas\'s Aegis of Rapt Concentration' }, { id: 30889, name: 'Kaz\'rogal\'s Hardened Heart' }],
  ...
  5: {
    ...
    chest: [{ id: 34216, name: 'Heroic Judicator\'s Chestguard' }, { id: 30991, name: 'Lightbringer Chestguard' }, { id: 34945, name: 'Shattrath Protectorate\'s Breastplate' }, { id: 34941, name: 'Chestplate of Stoicism', note: 'Badge of Justice (P5) vendor — high defense/block EHP tank chest (no spell power).' }],
    ...
    waist: [{ id: 34488, name: 'Lightbringer Waistguard' }, { id: 32342, name: 'Girdle of Mighty Resolve' }, { id: 33524, name: 'Girdle of the Protector' }, { id: 34940, name: 'Girdle of the Fearless', note: 'Badge of Justice (P5) vendor — threat belt (hit + expertise + defense).' }],
    legs: [{ id: 34167, name: 'Legplates of the Holy Juggernaut' }, { id: 34382, name: 'Judicator\'s Legguards' }, { id: 30995, name: 'Lightbringer Legguards' }, { id: 34946, name: 'Inscribed Legplates of the Aldor', note: 'Badge of Justice (P5) vendor — top avoidance + spell-power tank legs.' }, { id: 34939, name: 'Sunguard Legplates', note: 'Badge of Justice (P5) vendor — defense/expertise threat-tank legs (no spell power).' }],

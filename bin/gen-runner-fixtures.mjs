...
const ITEMS = [
  ...
  it({ itemId: 29068, slot: 'head', equipLoc: 'INVTYPE_HEAD', name: 'Justicar Faceguard', stats: { stamina: 55, defenseRating: 40, dodgeRating: 25, spellDamage: 18, armor: 1300 } }),
  ...
  it({ itemId: 60010, slot: 'shoulder', equipLoc: 'INVTYPE_SHOULDER', name: 'Pauldrons', stats: { stamina: 30, defenseRating: 24, spellDamage: 16, armor: 800 }, enchantId: 2978 }),
  // chest — Justicar (29066) socketed with a def bonus, + a threat chest
  it({ itemId: 29066, slot: 'chest', equipLoc: 'INVTYPE_CHEST', name: 'Justicar Chestguard', stats: { stamina: 60, defenseRating: 45, parryRating: 30, armor: 1500 }, sockets: { red: 1, yellow: 1 }, socketBonus: { stat: 'defenseRating', value: 4 } }),
  ...
  it({ itemId: 60030, slot: 'legs', equipLoc: 'INVTYPE_LEGS', name: 'Legguards', stats: { stamina: 70, defenseRating: 40, dodgeRating: 30, armor: 1400 }, sockets: { red: 1, blue: 1, meta: 1 }, socketBonus: { stat: 'stamina', value: 6 } }),
  ...
  // hands (socketed, blue)
  it({ itemId: 60040, slot: 'hands', equipLoc: 'INVTYPE_HAND', name: 'Handguards', stats: { stamina: 35, defenseRating: 28, armor: 800 }, sockets: { blue: 1 }, socketBonus: { stat: 'stamina', value: 4 } }),
  // wrist / feet / back / waist
  it({ itemId: 60050, slot: 'wrist', equipLoc: 'INVTYPE_WRIST', name: 'Bracers', stats: { stamina: 24, defenseRating: 20, spellDamage: 12, armor: 500 } }),
  it({ itemId: 60060, slot: 'feet', equipLoc: 'INVTYPE_FEET', name: 'Boots', stats: { stamina: 30, dodgeRating: 20, spellDamage: 14, armor: 700 } }),
  it({ itemId: 60070, slot: 'back', equipLoc: 'INVTYPE_CLOAK', name: 'Cloak', stats: { stamina: 20, dodgeRating: 16, spellDamage: 12, armor: 250 } }),
  it({ itemId: 60080, slot: 'waist', equipLoc: 'INVTYPE_WAIST', name: 'Belt', stats: { stamina: 34, defenseRating: 24, blockRating: 18, armor: 800 } }),
  // neck — keep-lockable (filled yellow socket, no enchant slot)
  it({ itemId: 60090, slot: 'neck', equipLoc: 'INVTYPE_NECK', name: 'Pendant', stats: { stamina: 18, defenseRating: 16, hitRating: 8 }, sockets: { yellow: 1 }, gems: [24051] }),
  it({ itemId: 60091, slot: 'neck', equipLoc: 'INVTYPE_NECK', name: 'Threat Pendant', stats: { stamina: 12, spellDamage: 24, spellHitRating: 10 } }),
  // rings (3)
  it({ itemId: 60100, slot: 'ring', equipLoc: 'INVTYPE_FINGER', name: 'Ring A', stats: { stamina: 22, defenseRating: 20, dodgeRating: 14 } }),
  it({ itemId: 60101, slot: 'ring', equipLoc: 'INVTYPE_FINGER', name: 'Ring B', stats: { stamina: 14, spellDamage: 22, resilienceRating: 10 } }),
  ...
  it({ itemId: 29370, slot: 'trinket', equipLoc: 'INVTYPE_TRINKET', name: 'Icon of the Silver Crescent', stats: { spellDamage: 43, spellHitRating: 10 } }),
  it({ itemId: 28789, slot: 'trinket', equipLoc: 'INVTYPE_TRINKET', name: 'Eye of Magtheridon', stats: { spellDamage: 40, spellCritRating: 22 } }),
  ...
  it({ itemId: 60120, slot: 'weapon', equipLoc: 'INVTYPE_WEAPONMAINHAND', name: 'Mace', stats: { spellDamage: 55, hitRating: 12, stamina: 20 } }),
  it({ itemId: 60121, slot: 'weapon', equipLoc: 'INVTYPE_2HWEAPON', name: 'Big Mace', stats: { spellDamage: 95, stamina: 30 } }),
  // shields (2)
  it({ itemId: 60130, slot: 'offhand', equipLoc: 'INVTYPE_SHIELD', name: 'Shield A', stats: { stamina: 50, blockValue: 120, blockRating: 60, defenseRating: 30, armor: 3200 } }),
  ...
  it({ itemId: 32368, slot: 'relic', equipLoc: 'INVTYPE_RELIC', name: 'Libram of the Eternal Rest', stats: { spellDamage: 35 } }),
];
